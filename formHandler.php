...
$honeypot = $_POST["honeypot"];
	...
	if( $honeypot != "" ){
		; //Form will break on purpose to prvent submission.
	...
	$inSchool = $_POST["school"];			//Get the value entered in the school field
  	$inAnimal = $_POST["animal"];
    $inWork = $_POST["workToday"];
    $inCity = $_POST["city"];
?>
<!DOCTYPE html>
<head>
...
<p>Favorit Animal: <?php echo $inAnimal; ?></p>
<p>Work Today? <?php echo $inWork; ?></p>
<p>City Live In: <?php echo $inCity; ?></p>
</body>
</html>
<?php } ?>